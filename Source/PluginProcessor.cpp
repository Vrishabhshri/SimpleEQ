...
juce::AudioProcessorValueTreeState::ParameterLayout SimpleEQAudioProcessor::createParameterLayout()
{
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>(juce::ParameterID("PeakCutFreq", 1), "PeakCutFreq", juce::NormalisableRange<float>(20.f, 20000.f, 1.f, 1.f), 750.f));
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>(juce::ParameterID("PeakQ", 1), "PeakQ", juce::NormalisableRange<float>(0.1f, 10.f, 0.05f, 1.f), 1.f));
